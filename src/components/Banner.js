                ...
                <div className="lg:flex justify-between gap-x-5 px-10  md:px-12 lg:px-20  pb-3 ">
                    ...
                    <div className="lg:w-1/2  flex items-center ">
                        <div className='lg:pl-5'>
                            ...
                            <div>
                                <a href="https://drive.google.com/uc?export=download&id=1hOgBRU1ZYqltxjTehrzOBxPbeR4HVWOX" className='mt-5 lg:mt-9 inline-block text-primary underline underline-offset-2 hover:text-primary-dark transition-all ease-linear duration-200'>
